...
from std_msgs.msg import String  # Mengganti Twist ke String
import cv2
import numpy as np
...
class ImageDetectorNode(Node):
    def __init__(self):
        ...
        # ROS 2 Publisher (Mengirim tipe data String)
        ...
        # Timer untuk menjalankan deteksi & publish setiap 1 detik
    ...
    def process_and_publish(self):
        ...
        # Morphological operations (Membersihkan noise)
        ...
        # Menampilkan output OpenCV
        cv2.imshow("Frame", frame)
        cv2.imshow("Mask", mask)
        cv2.waitKey(1) # Memberi waktu OpenCV untuk merender window
    ...
    def __del__(self):
        # Memastikan kamera dilepas saat node mati
